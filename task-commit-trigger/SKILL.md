...
- Is the commit message structured as WHAT/HOW/WHY and grounded in the actual diff?
- Is the commit only executed after explicit user approval?
- Does the message avoid exposing secrets or unrelated changes?
