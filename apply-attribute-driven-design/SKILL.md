...
- Do the architectural drivers map step-by-step to design concepts (patterns/tactics)?
- Are ADD iterations documented with explicit inputs and outputs per step?
- Could another architect reproduce the design decisions from the record?
