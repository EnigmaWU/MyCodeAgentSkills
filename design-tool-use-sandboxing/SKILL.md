...
- Are dangerous tools gated by HITL approval, containers, timeouts, and minimal mounts?
- Is the approval prompt explicit about the exact command, arguments, and consequences?
- Is there a defined fallback path when execution is rejected?
