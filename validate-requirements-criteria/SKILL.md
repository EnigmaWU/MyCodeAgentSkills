...
- Does the validation flag ambiguity, missing exception paths, and untestable claims?
- Are the resulting BDD criteria executable and mapped to the original requirement?
- Is every requirement marked valid/invalid with explicit reasoning?
