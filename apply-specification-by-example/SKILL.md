...
- Are business rules expressed through concrete examples with explicit expected results?
- Is every example traceable to a business rule and an automated check?
- Are ambiguous or missing examples flagged instead of silently assumed?
