...
1. Map evidence to lifecycle stages using [lifecycle-assessment](details/lifecycle-assessment.md): generation/source systems, storage, ingestion, transformation, and serving.
...
1. Review cross-cutting undercurrents using [undercurrents-review](details/undercurrents-review.md): security/privacy, data management, DataOps, data architecture, orchestration, software engineering, and cost.
...
1. Use [review-report-template](details/review-report-template.md) to write the report.
2. Run [validation-checklist](details/validation-checklist.md) against the report.
...
## Resources
- [evidence-discovery](details/evidence-discovery.md) - Repository evidence patterns for data engineering reviews.
- [lifecycle-assessment](details/lifecycle-assessment.md) - Generation, storage, ingestion, transformation, and serving review advice.
- [undercurrents-review](details/undercurrents-review.md) - Cross-cutting security, data management, DataOps, architecture, orchestration, software engineering, and cost review prompts.
- [review-report-template](details/review-report-template.md) - Findings-first report structure.
- [validation-checklist](details/validation-checklist.md) - Final validation gate for review quality.
