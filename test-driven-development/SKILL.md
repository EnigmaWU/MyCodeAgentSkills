...
- Does every production behavior have a test that existed and failed first?
- Are tests behavioral rather than implementation-detail obsessed, without test-only production hacks?
- Would the Red-Green-Refactor loop catch the next regression?
