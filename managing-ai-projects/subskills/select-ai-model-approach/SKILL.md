...
- Is the recommendation tied to the required capability and data constraints, not a default preference?
- Are build-vs-leverage, baseline-vs-best, cost, and explainability tradeoffs explicit?
- Are evaluation metrics and "good enough" thresholds defined before the choice is accepted?
