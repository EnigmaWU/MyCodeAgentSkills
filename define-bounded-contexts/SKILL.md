...
- Are subdomains classified as core/supporting/generic with explicit rationale?
- Is every bounded context mapped with a defined relationship type (context map)?
- Does each term mean exactly one thing per context, with no hidden shared models?
