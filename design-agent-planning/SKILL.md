...
- Does the planner decompose goals into atomic, ordered, verifiable sub-tasks?
- Are completion states and replanning wired so a skipped or incomplete step fails loudly?
- Does the workflow exit only when all steps are marked complete?
