...
- Is the System Under Design distinguished from every external system and actor?
- Are all upstream/downstream interactions from the source text represented?
- Is the Mermaid graph valid and free of invented integrations?
